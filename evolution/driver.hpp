...
//	request.code = code;
//
//	const auto result = fnAddr(&request, NULL, NULL);
...
//	return true;
//}
//bool kinterface_t::Initialize(/*int processid*/) {
//	LoadLibraryA(OBF("user32.dll"));
//	HMODULE win32u = LoadLibraryA(OBF("win32u.dll"));
//	if (!win32u) {
//		return false;
//	}
//
//	*(void**)&fnAddr = GetProcAddress(win32u, OBF("NtCompositionInputThread"));
//	if (!fnAddr) {
//		return false;
//	}
//
